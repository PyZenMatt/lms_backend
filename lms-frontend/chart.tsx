...
function ChartContainer({
  ...
  return (
    ...
    type TooltipItem = {
      ...
      payload?: { [k: string]: unknown; fill?: string } | undefined;
      color?: string;
      [k: string]: unknown;
    };
    ...
    function ChartTooltipContent({
      ...
      label?: unknown;
      labelFormatter?: (value: unknown, payload?: TooltipItem[] | undefined) => React.ReactNode;
      labelClassName?: string;
      formatter?: (value: unknown, name?: string, item?: TooltipItem, index?: number, payload?: TooltipItem[] | undefined) => React.ReactNode;
      color?: string;
      nameKey?: string;
      labelKey?: string;
    }) {
    ...
    function getPayloadConfigFromPayload(
      ...
      const payloadPayload =
        ...
        (payload as Record<string, unknown>).payload !== null
          ? (payload as Record<string, any>).payload
          : undefined;
      ...
      if (
        ...
        configLabelKey = (payload as Record<string, any>)[key as keyof typeof payload] as string;
      } else if (
        payloadPayload &&
