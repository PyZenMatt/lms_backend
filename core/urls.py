...
from .batch_api import CourseBatchDataAPI, LessonBatchDataAPI, StudentBatchDataAPI
...
urlpatterns = [
    ...
    path(
        "dashboard/transactions/", dashboard_transactions, name="dashboard-transactions"
    ),
    ...
    # ============================================
    path(
        "api/student/batch-data/",
        StudentBatchDataAPI.as_view(),
        name="student-batch-data",
    ),
    path(
        "api/course/<int:course_id>/batch-data/",
        CourseBatchDataAPI.as_view(),
        name="course-batch-data",
    ),
    path(
        "api/lesson/<int:lesson_id>/batch-data/",
        LessonBatchDataAPI.as_view(),
        name="lesson-batch-data",
    ),
    # ============================================
    # INTEGRATED APPS
    # ============================================
