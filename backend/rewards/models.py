...
class BlockchainTransaction(models.Model):
    ...
    tx_hash = models.CharField(
        max_length=66, unique=True, blank=True, null=True)
    ...
    related_object_id = models.CharField(
        max_length=100, blank=True, null=True)  # Course ID or other object ID
...
class TeacherDiscountAbsorption(models.Model):
    ...
    option_a_platform_eur = models.DecimalField(
    ...
    option_b_teacher_teo = models.DecimalField(
        max_digits=10, decimal_places=2)  # includes 25% bonus
    option_b_platform_eur = models.DecimalField(
        max_digits=10, decimal_places=2)

    # Decision tracking
    status = models.CharField(
        max_length=20, choices=CHOICE_STATUS, default='pending')
    created_at = models.DateTimeField(auto_now_add=True)
    ...
    def calculate_options(self):
        ...
        self.option_b_teacher_teo = self.teo_used_by_student * \
