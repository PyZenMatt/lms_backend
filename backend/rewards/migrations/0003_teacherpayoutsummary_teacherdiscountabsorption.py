    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "eur_from_standard_sales",
                    models.DecimalField(
                        decimal_places=2, default=Decimal("0"), max_digits=10
                    ),
                ),
                (
                    "eur_from_absorbed_discounts",
                    models.DecimalField(
                        decimal_places=2, default=Decimal("0"), max_digits=10
                    ),
                ),
                (
                    "teo_from_absorbed_discounts",
                    models.DecimalField(
                        decimal_places=2, default=Decimal("0"), max_digits=10
                    ),
                ),
            ...
            options={
                ...
                "unique_together": {
                    ("teacher", "period_start", "period_end", "period_type")
                },
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "option_a_platform_eur",
                    models.DecimalField(decimal_places=2, max_digits=10),
                ),
                (
                    "option_b_teacher_eur",
                    models.DecimalField(decimal_places=2, max_digits=10),
                ),
                (
                    "option_b_teacher_teo",
                    models.DecimalField(decimal_places=2, max_digits=10),
                ),
                (
                    "option_b_platform_eur",
                    models.DecimalField(decimal_places=2, max_digits=10),
                ),
                (
                    "status",
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="generated_absorptions",
                        to=settings.AUTH_USER_MODEL,
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="discount_absorptions",
                        to=settings.AUTH_USER_MODEL,
                    ),
                ),
            ],
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="rewards_tea_teacher_aa807e_idx",
                    ),
                    models.Index(
                        fields=["status", "expires_at"],
                        name="rewards_tea_status_d610dc_idx",
                    ),
                    models.Index(
                        fields=["created_at"], name="rewards_tea_created_daa01a_idx"
                    ),
                ],
            },
        ),
