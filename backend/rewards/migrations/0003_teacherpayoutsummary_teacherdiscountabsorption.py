    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('period_type', models.CharField(choices=[
                 ('weekly', 'Weekly'), ('monthly', 'Monthly')], max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True,
                 primary_key=True, serialize=False, verbose_name='ID')),
                ('course_price_eur', models.DecimalField(
                    decimal_places=2, max_digits=10)),
                ('discount_percentage', models.IntegerField()),
                ('teo_used_by_student', models.DecimalField(
                    decimal_places=2, max_digits=10)),
                ...
                ('option_a_teacher_eur', models.DecimalField(
                    decimal_places=2, max_digits=10)),
                ('option_a_platform_eur', models.DecimalField(
                    decimal_places=2, max_digits=10)),
                ('option_b_teacher_eur', models.DecimalField(
                    decimal_places=2, max_digits=10)),
                ('option_b_teacher_teo', models.DecimalField(
                    decimal_places=2, max_digits=10)),
                ('option_b_platform_eur', models.DecimalField(
                    decimal_places=2, max_digits=10)),
                ('status', models.CharField(choices=[('pending', 'Pending Decision'), ('absorbed', 'TEO Absorbed'), (
                    'refused', 'EUR Preferred'), ('expired', 'Expired (Auto-EUR)')], default='pending', max_length=20)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ...
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                 related_name='generated_absorptions', to=settings.AUTH_USER_MODEL)),
                ('teacher', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                 related_name='discount_absorptions', to=settings.AUTH_USER_MODEL)),
            ],
            options={
