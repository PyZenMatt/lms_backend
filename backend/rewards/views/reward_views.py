                ...
                return Response(
                    {
                        ...
                        "data": {
                            ...
                            "course_completion_bonus": result.get(
    ...
    try:
        ...
        try:
            ...
            summary = reward_service.get_user_rewards_summary(
                user_id=int(user_id), time_period=time_period
            )
    ...
    try:
        ...
        try:
            ...
            if reward_type not in ACHIEVEMENT_TYPES:
                return Response(
                    {"error": "Invalid reward type"}, status=status.HTTP_400_BAD_REQUEST
                )
        except ValueError:
            return Response(
                {"error": "Invalid reward type"}, status=status.HTTP_400_BAD_REQUEST
        ...
        for user_id in user_ids:
            try:
                ...
                results.append(
                    {"user_id": user_id, "success": False, "message": "User not found"}
                )
            except Exception as e:
