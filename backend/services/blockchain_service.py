...
from services.exceptions import BlockchainTransactionError, WalletNotFoundError
...
class BlockchainService(TransactionalService):
    ...
    def get_user_wallet_balance(self, user: User) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "token_info": {"name": "TeoCoin", "symbol": "TEO", "decimals": 18},
            }
    ...
    def mint_tokens_to_user(
        ...
        def _mint_operation():
            ...
            if amount_decimal <= 0:
                raise BlockchainTransactionError(
                    "Amount must be positive", code="INVALID_AMOUNT", status_code=400
                )
