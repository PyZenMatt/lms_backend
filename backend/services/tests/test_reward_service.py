...
class RewardServiceTestCase(TestCase):
    ...
    def test_process_lesson_completion_reward_already_processed(self):
        ...
        self.assertIn(
            "Lesson completion reward already processed", str(cm.exception))
    ...
    def test_process_course_completion_bonus_already_processed(self):
        ...
        self.assertIn("Course completion bonus already processed",
                      str(cm.exception))
    ...
    def test_get_user_rewards_summary(self):
        ...
        self.assertEqual(
            summary_data['total_rewards_earned'], 14.0)  # 2 + 2 + 10
        ...
        self.assertEqual(summary['recent_rewards'][0]
                         ['amount'], 10.0)  # Most recent first
    ...
    def test_calculate_lesson_reward(self):
        ...
        reward = reward_service._calculate_lesson_reward(
            self.course, self.lesson1)
    ...
    def test_check_course_completion(self):
        ...
        # No completions yet
        self.assertFalse(reward_service._check_course_completion(
        ...
        self.assertTrue(reward_service._check_course_completion(
            self.student, self.course))
