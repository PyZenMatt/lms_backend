...
class UserServiceIntegrationTest(TestCase):
    ...
    def test_pending_teachers_endpoint(self):
        ...
        self.assertEqual(data['data'][0]['email'],
                         'integration_teacher@test.com')
    ...
    def test_approve_teacher_endpoint(self):
        ...
        response = self.client.post(
            f'/api/v1/approve-teacher/{self.teacher.id}/')
        ...
        data = response.json()
        self.assertIn('data', data)
        self.assertEqual(data['data']['teacher_email'],
                         'integration_teacher@test.com')
    ...
    def test_reject_teacher_endpoint(self):
        ...
        self.assertEqual(data['data']['rejection_reason'],
