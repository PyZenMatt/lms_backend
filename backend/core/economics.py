...
class PlatformEconomics:
    ...
    TEOCOIN_EURO_EXCHANGE_RATE = Decimal(
        '0.50')    # 1 TEO = €0.50 for discounts
    ...
    COURSE_COMPLETION_REWARD_RATE = Decimal(
        '0.10')  # 10% of course price as TEO reward
    ...
    def calculate_staking_economics(cls, course_price_eur: Decimal, teacher_teo_staked: Decimal = Decimal('0')) -> dict:
        ...
        bronze_commission = course_price_eur * \
            cls.STAKING_TIERS['bronze']['commission_rate']
        bronze_teacher = course_price_eur * \
            cls.STAKING_TIERS['bronze']['teacher_rate']
