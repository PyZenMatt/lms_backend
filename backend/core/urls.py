...
from .analytics import analytics_dashboard, public_stats, revenue_chart_data
from .api import dashboard_data
from .batch_api import (CourseBatchDataAPI, LessonBatchDataAPI,
                        StudentBatchDataAPI)
# Import views
from .dashboard import (AdminDashboardAPI, StudentDashboardView,
                        TeacherDashboardAPI, UserRoleDashboardAPI,
...
urlpatterns = [
    ...
    path('dashboard/role/', UserRoleDashboardAPI.as_view(),
         name='user-role-dashboard'),
    path('dashboard/transactions/', dashboard_transactions,
    ...
    # ============================================
    path('api/student/batch-data/', StudentBatchDataAPI.as_view(),
         name='student-batch-data'),
    path('api/course/<int:course_id>/batch-data/',
         CourseBatchDataAPI.as_view(), name='course-batch-data'),
    path('api/lesson/<int:lesson_id>/batch-data/',
         LessonBatchDataAPI.as_view(), name='lesson-batch-data'),
