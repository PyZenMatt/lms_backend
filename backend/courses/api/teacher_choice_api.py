...
from courses.serializers import (TeacherChoicePreferenceSerializer,
...
class TeacherChoiceViewSet(viewsets.ModelViewSet):
    ...
    def earnings_comparison(self, request, pk=None):
        ...
        try:
            ...
            fiat_difference = earnings_declined['fiat'] - \
                earnings_accepted['fiat']
...
class TeacherPreferenceViewSet(viewsets.ModelViewSet):
    ...
    def update_preference(self, request):
        ...
        try:
            ...
            valid_choices = [choice[0]
                             for choice in TeacherChoicePreference.PREFERENCE_CHOICES]
    ...
    def statistics(self, request):
        ...
        try:
            ...
            decisions = TeacherDiscountDecision.objects.filter(
            ...
            pending = decisions.filter(
                decision='pending', expires_at__gt=timezone.now()).count()
