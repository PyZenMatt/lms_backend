    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.PositiveIntegerField(default=0, validators=[django.core.validators.MinValueValidator(0, message='Il prezzo non può essere negativo')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('difficulty', models.CharField(choices=[('beginner', 'Principiante'), ('intermediate', 'Intermedio'), ('advanced', 'Avanzato')], default='beginner', help_text='Livello di difficoltà', max_length=20)),
