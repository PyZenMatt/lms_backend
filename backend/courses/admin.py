...
from .models import Course, Exercise, ExerciseReview, ExerciseSubmission, Lesson, User
    ...
    def get_search_results(self, request, queryset, search_term):
        if "autocomplete" in request.path:
            ...
            if field_name == "students":
                return (
                    User.objects.filter(
                        role="student", username__icontains=search_term
                    ),
                    False,
                )
                ...
                return (
                    User.objects.filter(
                        role="teacher", username__icontains=search_term
                    ),
                    False,
                )
