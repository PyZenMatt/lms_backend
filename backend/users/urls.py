...
from .views import (ApproveTeacherView, PendingTeachersView, RejectTeacherView,
                    UserProfileView, UserProgressView, UserSettingsView)
from .views.self_verify import SelfVerifyView
from .views.wallet_views import ConnectWalletView, DisconnectWalletView

urlpatterns = [
    path('pending-teachers/', PendingTeachersView.as_view(),
         name='pending-teachers'),
    path('approve-teacher/<int:user_id>/',
         ApproveTeacherView.as_view(), name='approve-teacher'),
    path('reject-teacher/<int:user_id>/',
         RejectTeacherView.as_view(), name='reject-teacher'),
    ...
    path('wallet/disconnect/', DisconnectWalletView.as_view(),
