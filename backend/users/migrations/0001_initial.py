    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('student', 'Studente'), ('teacher', 'Maestro'), ('admin', 'Amministratore')], error_messages={'invalid_choice': '"%(value)s" non è una scelta valida.'}, max_length=10)),
