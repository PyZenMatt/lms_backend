...
from .discount_views import (ApproveDiscountRequestView,
                             CalculateDiscountCostView,
                             CreateDiscountRequestView,
                             DeclineDiscountRequestView,
                             DiscountRequestDetailView, DiscountStatsView,
                             SignatureDataView, StudentRequestsView,
                             SystemStatusView, TeacherRequestsView)
...
urlpatterns = [
    ...
    path('request/<int:request_id>/',
         DiscountRequestDetailView.as_view(), name='request_detail'),
    path('student/<str:student_address>/',
         StudentRequestsView.as_view(), name='student_requests'),
    path('teacher/<str:teacher_address>/',
         TeacherRequestsView.as_view(), name='teacher_requests'),
