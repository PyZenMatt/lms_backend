...
class TeoCoinBalanceView(APIView):
    ...
    def get(self, request):
        ...
        try:
            ...
            logger.error(
                f"Error getting balance for user {request.user.id}: {e}")
            return Response({
                'success': False,
...
class CalculateDiscountView(APIView):
    ...
    def post(self, request):
        ...
        try:
            ...
            logger.error(
                f"Error calculating discount for user {request.user.id}: {e}")
            return Response({
                'success': False,
    ...
    def post(self, request):
        ...
        try:
            ...
            discount_percentage = Decimal(
                str(request.data.get('discount_percentage', '0')))
...
class PurchaseCourseView(APIView):
    ...
    def post(self, request):
        ...
        try:
            ...
            # Get updated balance
            new_balance_data = hybrid_teocoin_service.get_user_balance(
                request.user)
...
class StakeTokensView(APIView):
    ...
    def post(self, request):
        ...
        try:
            ...
            logger.error(
                f"Error staking tokens for user {request.user.id}: {e}")
            return Response({
                'success': False,
...
class UnstakeTokensView(APIView):
    ...
    def post(self, request):
        ...
        try:
            ...
            logger.error(
                f"Error unstaking tokens for user {request.user.id}: {e}")
            return Response({
                'success': False,
...
class StakingInfoView(APIView):
    ...
    def get(self, request):
        ...
        try:
            ...
            logger.error(
                f"Error getting staking info for user {request.user.id}: {e}")
            return Response({
                'success': False,
...
class WithdrawTokensView(APIView):
    ...
    def post(self, request):
        ...
        try:
            ...
            logger.error(
                f"Error creating withdrawal for user {request.user.id}: {e}")
            return Response({
                'success': False,
...
class TransactionHistoryView(APIView):
    ...
    def get(self, request):
        ...
        try:
            ...
            logger.error(
                f"Error getting transactions for user {request.user.id}: {e}")
            return Response({
                'success': False,
