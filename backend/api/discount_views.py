    ...
    def post(self, request):
        try:
            ...
            try:
                ...
                logger.error(
                    f"UTF-8 encoding error in signature generation: {e}")
            ...
            if result['success']:
                ...
                try:
                    ...
                    try:
                        ...
                        logger.info(
                            f"✅ Teacher notification sent to {teacher.email}")
                    ...
                    logger.error(
                        f"⚠️ Django model creation failed: {django_error}")
...
class StudentRequestsView(BaseDiscountView):
    ...
    def get(self, request, student_address):
        try:
            ...
            requests = teocoin_discount_service.get_student_requests(
                student_address)
            ...
            logger.error(
                f"Error getting student requests for {student_address}: {e}")
            return self.error_response(str(e), status=500)
...
class TeacherRequestsView(BaseDiscountView):
    ...
    def get(self, request, teacher_address):
        try:
            ...
            requests = teocoin_discount_service.get_teacher_requests(
                teacher_address)
            ...
            logger.error(
                f"Error getting teacher requests for {teacher_address}: {e}")
            return self.error_response(str(e), status=500)
