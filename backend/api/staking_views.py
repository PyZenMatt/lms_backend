...
def get_staking_info(request):
    ...
    try:
        ...
        next_tier_requirement = tier_requirements.get(
            teacher_profile.staking_tier)
        ...
        logger.error(
            f"Error getting staking info for {request.user.email}: {str(e)}")
        return Response({
            'success': False,
...
def stake_tokens(request):
    ...
    try:
        ...
        logger.error(
            f"Error staking tokens for {request.user.email}: {str(e)}")
        return Response({
            'success': False,
...
def unstake_tokens(request):
    ...
    try:
        ...
        logger.error(
            f"Error unstaking tokens for {request.user.email}: {str(e)}")
        return Response({
            'success': False,
