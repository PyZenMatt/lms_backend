...
urlpatterns = [
    ...
    path(
        ...
        DBWithdrawalStatusView.as_view(),
    ...
    path(
        "teacher/absorptions/",
        TeacherPendingAbsorptionsView.as_view(),
        name="teacher_pending_absorptions",
    ),
    path(
        "teacher/absorptions/pending/",
        TeacherPendingAbsorptionsView.as_view(),
        name="teacher_pending_absorptions_alt",
    ),
    path(
        "teacher/absorptions/choose/",
        TeacherMakeAbsorptionChoiceView.as_view(),
    ...
    path(
        "teacher/absorptions/history/",
        TeacherAbsorptionHistoryView.as_view(),
    ...
    path(
        "legacy/withdraw/<int:withdrawal_id>/cancel/",
        CancelWithdrawalView.as_view(),
        name="legacy_cancel_withdrawal",
    ),
    path(
        "legacy/withdrawals/",
        UserWithdrawalHistoryView.as_view(),
        name="legacy_withdrawal_history",
    ),
    path("legacy/balance/", DBTeoCoinBalanceView.as_view(), name="legacy_balance"),
    path(
        "legacy/transactions/",
        TeoCoinTransactionHistoryView.as_view(),
    ...
    path(
        ...
        StudentTeoCoinTransactionHistoryView.as_view(),
        name="student_transactions",
    ),
    # Admin Endpoints
    path(
        "admin/withdrawals/pending/",
        AdminPendingWithdrawalsView.as_view(),
    ...
    path(
        "admin/absorptions/overview/",
        AdminAbsorptionOverviewView.as_view(),
