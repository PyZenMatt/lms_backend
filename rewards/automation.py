...
class AutomatedRewardSystem:
    ...
    def reward_lesson_completion(
        self, student: User, lesson: Lesson, course: Course = None
    ):
        """
            ...
            with transaction.atomic():
                ...
                if hasattr(course, "reward_distributed"):
                    course.reward_distributed = (
                        course.reward_distributed or 0
                    ) + reward_amount
        ...
        try:
            ...
            if total_lessons > 0 and completed_lessons >= total_lessons:
                ...
                enrollment, created = CourseEnrollment.objects.get_or_create(
                    student=student, course=course, defaults={"completed": True}
                )
    ...
    def _award_blockchain_tokens(
        self, user: User, amount: int, reward_type: str, related_id: int
    ):
        """
    ...
    def calculate_achievement_reward(
        self, achievement_type: str, course: Course = None
    ) -> int:
        """
    ...
    def award_achievement(
        self, student: User, achievement_type: str, course: Course = None
    ):
        """
    ...
    def get_student_reward_summary(self, student: User, course: Course = None):
        ...
        if course:
            ...
            course_bonuses = queryset.filter(
                transaction_type="course_completion_bonus", related_object_id=course.id
            )
            ...
            achievement_rewards = queryset.filter(
                transaction_type="achievement_reward", related_object_id=course.id
            )
        ...
        return {
            ...
            "achievements": reward_transactions.filter(
                transaction_type="achievement_reward"
            ).count(),
