        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                choices=[
                    ...
                    (
                        "teocoin_discount_pending",
                        "TeoCoin Discount - Teacher Decision Required",
                    ),
                    (
                        "teocoin_discount_accepted",
                        "TeoCoin Discount - Accepted by Teacher",
                    ),
                    (
                        "teocoin_discount_rejected",
                        "TeoCoin Discount - Rejected by Teacher",
                    ),
                    (
                        "teocoin_discount_expired",
                        "TeoCoin Discount - Expired (Auto-Rejected)",
                    ),
