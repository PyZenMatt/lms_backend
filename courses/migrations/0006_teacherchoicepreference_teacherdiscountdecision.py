    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.OneToOneField(
                        ...
                        related_name="choice_preference",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "teo_cost",
                    models.BigIntegerField(help_text="TEO cost in wei (18 decimals)"),
                ),
                (
                    "teacher_bonus",
                ...
                (
                    ...
                    models.DecimalField(
                        decimal_places=2,
                        help_text="Commission rate at time of request",
                        max_digits=5,
                    ),
                ),
                (
                ...
                (
                    "expires_at",
                    models.DateTimeField(help_text="When the decision expires"),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
                (
                    "student_transaction_hash",
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="discount_decisions",
                        to="courses.course",
                    ),
                ),
                (
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["teacher", "decision"],
                        name="courses_tea_teacher_894478_idx",
                    ),
                    models.Index(
                        fields=["student", "created_at"],
                        name="courses_tea_student_024751_idx",
                    ),
                    models.Index(
                        fields=["expires_at"], name="courses_tea_expires_275f7f_idx"
                    ),
                ],
            },
        ),
