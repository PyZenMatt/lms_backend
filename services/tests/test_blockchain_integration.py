...
class BlockchainViewsIntegrationTest(TestCase):
    ...
    def setUp(self):
        ...
        if hasattr(self.staff_user, "wallet_address"):
            self.staff_user.wallet_address = (
    ...
    def test_get_wallet_balance_authenticated(self):
        ...
        if response.status_code == 200:
            ...
            print(
                "✅ Get wallet balance endpoint handled gracefully during transition!"
            )
    ...
    def test_get_transaction_history(self):
        ...
        if response.status_code == 200:
            ...
            print(
                "✅ Transaction history endpoint handled gracefully during transition!"
            )
    ...
    def test_reward_user_requires_staff(self):
        ...
        response = self.client.post(
            "/blockchain/reward/",
            {"user_id": self.user.id, "amount": "50.0", "reason": "Test reward"},
            format="json",
        )
