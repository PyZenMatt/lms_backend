...
import { Card, Button, Alert, Badge } from '@/components/ui/legacy-shims';
      ...
      <Card.Body>
        ...
        {walletState.connected ? (
          <div className="text-center">
            ...
            <div className="mb-3">
              ...
              <div className="d-flex align-items-center justify-content-center">
                <code className="bg-light p-2 rounded me-2">{formatAddress(walletState.address)}</code>
                <Button
            ...
            <div className="d-grid gap-2">
              <Button variant="outline-danger" onClick={disconnectWalletHandler} disabled={walletState.isLoading} size="sm">
          ...
          <div className="text-center">
            ...
            <p className="text-muted mb-3">Connetti il tuo wallet per visualizzare l'indirizzo</p>
            <div className="d-grid">
              <Button variant="primary" onClick={connectWalletHandler} disabled={walletState.isLoading}>
                {walletState.isLoading ? (
                  <>
                    <span className="spinner-border spinner-border-sm me-2" role="status" aria-hidden="true"></span>
                    Connettendo...
