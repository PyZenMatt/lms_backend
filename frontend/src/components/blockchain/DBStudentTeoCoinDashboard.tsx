...
const DBStudentTeoCoinDashboard = () => {
  ...
  return (
    <div className="student-teocoin-dashboard">
      ...
      <div className="grid grid-cols-12 gap-4 blockchain-components-row mb-3">
        {/* Burn & Deposit Component */}
        <div className="col-span-12 md:col-span-12 lg:col-span-6 xl:col-span-4 blockchain-component-col mb-3">
        ...
        <div className="col-span-12 md:col-span-12 lg:col-span-12 xl:col-span-4 blockchain-component-col mb-3">
