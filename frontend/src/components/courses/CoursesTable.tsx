...
import { Card, Badge, Button, Collapse, ProgressBar, InputGroup } from '@/components/ui';
    ...
    <div className="courses-grid-modern">
      ...
      <div className="grid grid-cols-12 gap-4">
        {courses.map((course) => {
          ...
          return (
            <div className="col-span-12 lg:col-span-6 xl:col-span-4 mb-4" key={course.id}>
              <Card className="course-bg-bg-card text-card-foreground rounded-lg border border-border shadow-sm text-bg-card text-card-foreground rounded-lg border border-border shadow-sm-foreground border border-border rounded-lg shadow-sm h-100 border-0 shadow-sm">
                ...
                <Card.Body className="course-header">
                  ...
                  <div className="course-stats mb-3">
                    <div className="grid grid-cols-12 gap-4 text-center g-2">
