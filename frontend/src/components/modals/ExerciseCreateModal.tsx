...
import { Modal, Button, Form, Alert, Spinner, Card, Badge, InputGroup } from '@/components/ui';
...
const ExerciseCreateModal = ({ show, onHide, onCreated, lessonId, courseId }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const errorMessage =
        err.response?.data?.detail || err.response?.data?.message || "Errore nella creazione dell'esercizio. Verifica tutti i campi.";
                    ...
                    <div className="grid grid-cols-12 gap-4">
                      <div className="col-span-12 md:col-span-6">
                        <Form.Group className="mb-3">
                          ...
                          {validationErrors.timeEstimate && <div className="text-danger small mt-1">{validationErrors.timeEstimate}</div>}
                        </Form.Group>
                      </div>
                    </div>
                  </Card.Body>
                  ...
                  <Card.Body>
                    ...
                    <Form.Group>
                      ...
                      <Form.Control
                        ...
                        required
                      />
                      <Form.Control.Feedback type="invalid">{validationErrors.materials}</Form.Control.Feedback>
                    </Form.Group>
                  </Card.Body>
                </Card>
                  ...
                  <Card.Body>
                    ...
                    <Form.Group>
                      ...
                      <Form.Control
                        ...
                        required
                      />
                      <Form.Control.Feedback type="invalid">{validationErrors.instructions}</Form.Control.Feedback>
                    </Form.Group>
                  </Card.Body>
                </Card>
              </div>
                    ...
                    {!imagePreview ? (
                      ...
                      >
                        <div className="upload-content">
                          ...
                          <small className="text-muted d-block mb-2">JPG, PNG, GIF (max 5MB)</small>
