...
import CustomToast from '../ui/ui-legacy/Toast';

import ErrorDisplay from '../ui/ui-legacy/ErrorDisplay';
...
const CourseCreateModal = ({ show, onHide, onCreated }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const errorMessage = err.response?.data?.detail || err.response?.data?.message || 'Errore nella creazione del corso. Verifica tutti i campi.';
    ...
    <Card className="border-0 shadow-sm">
      <CardContent>
        ...
        <div className="mb-4">
          ...
          />
          <small className="text-muted">Scegli un titolo chiaro e accattivante che descriva il contenuto del corso</small>
        ...
        <div className="mb-4">
          ...
          />
          <small className="text-muted">Una descrizione dettagliata aiuta gli studenti a capire cosa aspettarsi dal corso</small>
          {validationErrors.description && <p className="text-destructive text-sm">{validationErrors.description}</p>}
        </div>
        ...
        <div className="mb-3">
          ...
          <div className="flex items-stretch gap-2">
            <Input
              ...
              className="flex-1"
            />
            <span className="inline-flex items-center px-3 bg-muted text-muted-foreground">€</span>
          </div>
          <small className="text-muted">Imposta un prezzo in Euro. Gli studenti potranno usare TeoCoin per ottenere sconti!</small>
          {validationErrors.price && <p className="text-destructive text-sm">{validationErrors.price}</p>}
        </div>
      </CardContent>
    </Card>
  );
              ...
              <div key={groupName} className="mb-4">
                ...
                <div className="grid grid-cols-12 gap-4">
                  {groupCategories.map((cat) => (
                    <div className="col-span-12 sm:col-span-6 md:col-span-4 mb-2" key={cat.value}>
                      <div
          ...
          <div>
            ...
            <div className="grid grid-cols-12 gap-4">
              {levelOptions.map((levelOption) => (
                <div className="col-span-12 sm:col-span-6 md:col-span-3 mb-3" key={levelOption.value}>
                  <Card
    ...
    <Card className="border-0 shadow-sm">
      <CardContent>
          ...
          <div className="col-span-12 md:col-span-6">
            <div className="mb-4">
              ...
              <div className="flex items-stretch gap-2">
                ...
                <span className="inline-flex items-center px-3 bg-muted text-muted-foreground">ore</span>
              </div>
              <small className="text-muted">Stima il tempo totale necessario per completare il corso</small>
            </div>
          </div>
        </div>
        ...
        <div className="mb-4">
          ...
          <Textarea rows={3} value={prerequisites} onChange={(e) => setPrerequisites(e.target.value)} placeholder="es. Conoscenze di base del disegno, materiali artistici di base..." />
          <small className="text-muted">Specificare le conoscenze o materiali necessari (lascia vuoto se non ci sono prerequisiti)</small>
        </div>
        ...
        <div className="mb-3">
          ...
          {learningObjectives.map((objective, index) => (
            <div key={index} className="flex mb-2 gap-2">
              <Input value={objective} onChange={(e) => updateLearningObjective(index, e.target.value)} placeholder={`Obiettivo ${index + 1}...`} />
          ...
          <small className="text-muted d-block mt-2">Elenca cosa impareranno gli studenti completando questo corso</small>
        </div>
      </CardContent>
    </Card>
  );
    ...
    <>
      <Dialog open={show} onOpenChange={handleClose}>
        <DialogContent className="max-w-3xl">
          <DialogHeader>
            <DialogTitle className="d-flex items-center">
          ...
          <form onSubmit={handleSubmit}>
            <div className="pt-2">
              ...
              {error && (
                <Alert variant="danger" className="d-flex items-center mb-4">
              ...
              <div className="d-flex justify-content-between w-100">
                ...
                <div className="d-flex gap-2">
                  ...
                  {currentStep < totalSteps ? (
                    ...
                    <Button type="submit" variant={success ? 'success' : 'primary'} disabled={loading || !canProceedToNext() || success} className="px-4">
                      {success ? (
                        <>
