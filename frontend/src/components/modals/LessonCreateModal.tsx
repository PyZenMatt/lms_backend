...
const LessonCreateModal = ({ show, onHide, onCreated, courseId }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const errorMessage =
        err.response?.data?.detail || err.response?.data?.message || 'Errore nella creazione della lezione. Verifica tutti i campi.';
                ...
                <div className="grid grid-cols-12 gap-4">
                  <div className="col-span-12 md:col-span-6">
                    <Form.Group className="mb-3">
                      ...
                      {validationErrors.duration && <div className="text-danger small mt-1">{validationErrors.duration}</div>}
                    </Form.Group>
                  </div>
                </div>
              </Card.Body>
              ...
              <Card.Body>
                ...
                <div className="grid grid-cols-12 gap-4">
                  {lessonTypes.map((type) => (
                    <div className="col-span-12 sm:col-span-6 mb-3" key={type.value}>
                      <div
                        ...
                        <Card className={`h-100 ${lessonType === type.value ? 'border-primary' : ''}`}>
                          <Card.Body className="text-center p-3">
                            <Badge
                              ...
                              text={lessonType === type.value ? 'hsl(var(--background))' : 'dark'}
                  ...
                  {!videoPreview ? (
                    ...
                    >
                      <div className="upload-content">
                        ...
                        <small className="text-muted d-block mb-2">Formati supportati: MP4, AVI, MOV (max 200MB)</small>
