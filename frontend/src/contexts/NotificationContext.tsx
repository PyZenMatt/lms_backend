      ...
      const notificationMessage = (
        <div>
          ...
          <div style={{ fontSize: '0.8em', marginTop: '4px' }}>
            <a href={explorerUrl} target="_blank" rel="noopener noreferrer" style={{ color: 'inherit', textDecoration: 'underline' }}>
              View on PolygonScan
            </a>
          </div>
        </div>
