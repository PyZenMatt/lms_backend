...
import { Container, Card, Button, Alert, Modal, Form, Table, Badge, ProgressBar } from '@/components/ui';
                  ...
                  <div className="col-span-12 lg:col-span-12">
                    ...
                    <div className="grid grid-cols-12 gap-4">
                      {showcaseData.components.map((component, index) => (
                        <div className="col-span-12 md:col-span-6 lg:col-span-4 mb-3" key={index}>
                  ...
                  <div className="col-span-12 lg:col-span-12">
                    ...
                    <div className="grid grid-cols-12 gap-4">
                      {showcaseData.features.map((feature, index) => (
                        <div className="col-span-12 md:col-span-6 mb-3" key={index}>
                          <Card className="h-100">
                            <Card.Body>
