...
import { Container, Card, Button, Form, Badge, Alert } from '@/components/ui';
              ...
              <div className="mb-4">
                ...
                <div className="grid grid-cols-12 gap-4">
                  {themeOptions.map((option) => (
                    <div className="col-span-12 md:col-span-4 mb-3" key={option.id}>
                      <Card
                    ...
                    <Card.Body>
                      ...
                      <div className="grid grid-cols-12 gap-4">
                        {Object.entries(themeColors).map(([name, color]) => (
                          <div className="col-span-12 sm:col-span-6 md:col-span-3 mb-3" key={name}>
