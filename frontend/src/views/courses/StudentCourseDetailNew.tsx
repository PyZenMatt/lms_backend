...
import { Card, CardHeader, CardContent } from '../../components/ui/ui-legacy/Card';
import { Button } from '../../components/ui/ui-legacy/Button';
import { Alert } from '../../components/ui/ui-legacy/Alert';
import { Badge } from '../../components/ui/ui-legacy/Badge';
    ...
    <div className="page-wrapper">
      ...
      <div className="container">
        ...
        <div className="grid grid-cols-12 gap-4 mb-4">
          <div className="col-span-12 sm:col-span-6 md:col-span-3 mb-3">
            <Card>
              ...
              {lessons.length === 0 ? (
                ...
                <div className="grid grid-cols-12 gap-4">
                  {lessons.map((lesson, index) => (
                    <div className="col-span-12 md:col-span-6 xl:col-span-4 mb-3" key={lesson.id}>
                      <Card className="shadow-sm h-100">
        ...
        {/* Navigation */}
        <div className="grid grid-cols-12 gap-4 mt-4 mb-5">
            ...
            <div className="col-span-12 md:col-span-12">
              ...
              >
                {exercises.length === 0 ? (
                  ...
                  <div className="grid grid-cols-12 gap-4">
                    {exercises.map((ex) => (
                      <div className="col-span-12 md:col-span-6 xl:col-span-4 mb-3" key={ex.id}>
                        <Card className="shadow-sm h-100">
                          <Card.Body>
