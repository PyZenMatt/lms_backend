      ...
      <div className="container mt-4">
        ...
        <Row>
          <Col lg={8}>
            ...
            <Card className="mb-4">
              <Card.Header>
                <h5><i className="fas fa-dumbbell me-2"></i>Dettagli Esercizio</h5>
              </Card.Header>
              <Card.Body>
                <p><strong>Titolo:</strong> {submission.exercise?.title || 'N/A'}</p>
                <p><strong>Descrizione:</strong> {submission.exercise?.description || 'N/A'}</p>
                <p><strong>Data Sottomissione:</strong> {new Date(submission.created_at).toLocaleString()}</p>
              </Card.Body>
            </Card>
            ...
            <Card className="mb-4">
              <Card.Header>
                <h5><i className="fas fa-code me-2"></i>La Tua Soluzione</h5>
              </Card.Header>
              <Card.Body>
            ...
            {submission.reviews && submission.reviews.length > 0 && (
              <Card className="mb-4">
                <Card.Header>
                  <h5><i className="fas fa-star me-2"></i>Valutazioni Ricevute</h5>
                </Card.Header>
                <Card.Body>
                  <Row>
          ...
          <Col lg={4}>
            ...
            <Card className="mb-4">
              <Card.Header>
                <h5><i className="fas fa-trophy me-2"></i>Riepilogo Valutazione</h5>
              </Card.Header>
            ...
            <Card>
              <Card.Header>
                <h6><i className="fas fa-cogs me-2"></i>Azioni</h6>
              </Card.Header>
              <Card.Body>
