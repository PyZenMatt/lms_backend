...
import { Card, Button, Spinner, Alert, Badge, Form, InputGroup } from '@/components/ui';
...
const AllCourses = () => {
  ...
  return (
    <div className="container-fluid px-4 py-4">
      ...
      {/* Courses Grid */}
      <div className="grid grid-cols-12 gap-4 g-4">
        {filteredCourses.length === 0 ? (
          ...
          filteredCourses.map((course) => (
            <div className="col-span-12 md:col-span-6 lg:col-span-4" key={course.id}>
              <Card
