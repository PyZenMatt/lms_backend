  ...
  return (
    <div className="landing-page">
      ...
      <section className="hero-section">
        <Container>
          <div className="grid grid-cols-12 gap-4 align-items-center min-vh-100">
            <div className="col-span-12 lg:col-span-6 position-relative" style={{ zIndex: 5 }}>
            ...
            <div className="col-span-12 lg:col-span-6 position-relative">
      ...
      <section className="stats-section py-5 bg-light">
        <Container>
          <div className="grid grid-cols-12 gap-4 text-center mb-5">
