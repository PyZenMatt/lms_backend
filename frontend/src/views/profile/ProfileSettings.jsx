        ...
        <div className="container">
          <div className="enhanced-profile-header">
            <div className="enhanced-settings-header">
              ...
              <p className="enhanced-settings-subtitle">Personalizza la tua esperienza sulla piattaforma</p>
            </div>
          </div>
        </div>
      </div>
            ...
            <Form onSubmit={handleSave} className="enhanced-settings-form">
              ...
              <div className="enhanced-settings-section">
                <div className="enhanced-section-header">
                  ...
                  <p className="enhanced-section-description">Gestisci come e quando ricevere le notifiche</p>
                </div>
                ...
                <div className="enhanced-settings-grid">
                  <div className="enhanced-setting-item">
                    <div className="enhanced-setting-info">
                      ...
                      <p className="enhanced-setting-description">Ricevi notifiche via email per aggiornamenti importanti</p>
                    </div>
                  ...
                  <div className="enhanced-setting-item">
                    <div className="enhanced-setting-info">
                      ...
                      <p className="enhanced-setting-description">Ricevi notifiche push sul browser</p>
                    </div>
                    <div className="enhanced-toggle-switch">
                      <input
                        type="checkbox"
                  ...
                  <div className="enhanced-setting-item">
                    <div className="enhanced-setting-info">
                      ...
                      <p className="enhanced-setting-description">Ricorda i corsi in programma e le scadenze</p>
                    </div>
                    <div className="enhanced-toggle-switch">
                      <input
                        type="checkbox"
                  ...
                  <div className="enhanced-setting-item">
                    <div className="enhanced-setting-info">
                      ...
                      <p className="enhanced-setting-description">Ricevi un riassunto dei tuoi progressi ogni settimana</p>
                    </div>
                    <div className="enhanced-toggle-switch">
                      <input
                        type="checkbox"
                  ...
                  <div className="enhanced-setting-item">
                    <div className="enhanced-setting-info">
                      ...
                      <p className="enhanced-setting-description">Ricevi email promozionali su nuovi corsi e offerte</p>
                    </div>
                    <div className="enhanced-toggle-switch">
                      <input
                        type="checkbox"
              ...
              <div className="enhanced-settings-section">
                <div className="enhanced-section-header">
                  ...
                  <p className="enhanced-section-description">Personalizza l'aspetto dell'interfaccia</p>
                </div>
                ...
                <div className="enhanced-settings-grid">
                  <div className="enhanced-setting-item enhanced-setting-select">
                    <div className="enhanced-setting-info">
                      ...
                      <p className="enhanced-setting-description">Scegli tra tema chiaro o scuro</p>
                    </div>
                  ...
                  <div className="enhanced-setting-item enhanced-setting-select">
                    <div className="enhanced-setting-info">
                      ...
                      <p className="enhanced-setting-description">Seleziona la lingua dell'interfaccia</p>
                    </div>
                    <div className="enhanced-select-wrapper">
                      <Form.Select
                  ...
                  <div className="enhanced-setting-item enhanced-setting-select">
                    <div className="enhanced-setting-info">
                      ...
                      <p className="enhanced-setting-description">Il tuo fuso orario per date e orari</p>
                    </div>
                    <div className="enhanced-select-wrapper">
                      <Form.Select
              ...
              <div className="enhanced-settings-section">
                <div className="enhanced-section-header">
                  ...
                  <p className="enhanced-section-description">Controlla la visibilità delle tue informazioni</p>
                </div>
                ...
                <div className="enhanced-settings-grid">
                  <div className="enhanced-setting-item">
                    <div className="enhanced-setting-info">
                      ...
                      <p className="enhanced-setting-description">Permetti ad altri di vedere il tuo profilo</p>
                    </div>
                    <div className="enhanced-toggle-switch">
                      <input
                        type="checkbox"
                  ...
                  <div className="enhanced-setting-item">
                    <div className="enhanced-setting-info">
                      ...
                      <p className="enhanced-setting-description">Condividi i tuoi progressi nei corsi</p>
                    </div>
                    <div className="enhanced-toggle-switch">
                      <input
                        type="checkbox"
                  ...
                  <div className="enhanced-setting-item">
                    <div className="enhanced-setting-info">
                      ...
                      <p className="enhanced-setting-description">Rendi visibili i tuoi risultati e certificati</p>
                    </div>
                    <div className="enhanced-toggle-switch">
                      <input
                        type="checkbox"
