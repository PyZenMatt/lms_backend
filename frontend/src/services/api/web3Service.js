...
class Web3Service {
  ...
  /**
   * DEPRECATED: Direct course payment where student pays everything directly
   * @deprecated This method is no longer used. All course payments now use DB-based system.
   * Blockchain is only used for mint (withdrawals) and burn (deposits).
   */
  async processCoursePaymentDirectLegacy(studentAddress, teacherAddress, coursePrice, courseId) {
    throw new Error('Direct blockchain course payments are deprecated. Use DB-based payment system instead.');
  }
